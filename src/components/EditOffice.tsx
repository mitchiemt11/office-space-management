    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-lg mx-auto bg-white rounded-lg shadow-sm">
        <div className="flex items-center p-4 border-b">
          ...
          <h1 className="ml-4 text-xl font-semibold">Edit Office</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="pt-4 space-y-3">
            <button
              type="submit"
              className="w-full bg-blue-500 text-white py-3 px-4 rounded-full font-medium hover:bg-blue-600 transition-colors"
            >
              UPDATE OFFICE
            </button>
            ...
            <button
              ...
              className="w-full text-blue-500 py-3 px-4 rounded-full font-medium hover:bg-gray-100 transition-colors flex items-center justify-center gap-2"
            >
